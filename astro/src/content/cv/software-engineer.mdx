...
<div className="cv-content-column additional-column">
    <ProfileSection
        items={[
            "Aspiring <strong>problem solver</strong> & Software Engineer",
...
<div class="cv-content-column main-column">
    <ExpirienceSection topMargin={false} jobs={[
        {
            title: "Senior Software Engineer (R&D, Notebooks)",
            company: "DataRobot",
            location: "Ukraine",
        ...
        {
            title: "Software Engineer II (R&D, Notebooks)",
            company: "DataRobot",
            location: "Ukraine",
        ...
        {
            title: "Software Engineer (R&D, AI Apps)",
            company: "DataRobot",
            location: "Ukraine",
        ...
        },
        {
            ...
            highlights: [
                "<a target='_blank' rel='noopener' href='/cv/machine-learning-engineer/' title='Go to ML Engineer's Resume'>The rest of the ML engineering expirience could be found there.</a>",
            ],
            skills: [
                "data analysis",
                "tabular data",
        ...
        },
        {
            ...
            highlights: [
                ...
                "<a target='_blank' rel='noopener' href='/cv/ecommerce-developer/' title='Go to eCommerce Developer's Resume'>The rest of the eCommerce development expirience could be found there.</a>",
            ],
            skills: [
                "eCommerce",
                "Problem Solving",
