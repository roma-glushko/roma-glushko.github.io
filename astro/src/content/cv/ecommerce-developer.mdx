...
<div className="cv-content-column main-column">
    <section className="projects">
        ...
        <li className="project">
            ...
            <strong>Adobe Commerce Cloud just in 6 weeks</strong>. This included <strong>ERP and custom product configurator integrations, importing all B2B and catalog</strong>
