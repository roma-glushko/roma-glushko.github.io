...
![The Debug Workflow](/blog/jupyter-architecture/jupyter-kernel-debug-flow.png "The Debug Workflow")
...
Jupyter bindes one more port for the `debugpy` (REQ/REP) channel which is another bi-directional ZMQ stream that serves as a communication medium between the jupyter kernel and debugpy.
