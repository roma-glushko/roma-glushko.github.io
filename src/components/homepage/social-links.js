...
const SocialLinks = ({ iconSize, includeCV = true }) => {
  return (
    <div className="social">
      <ul className="social-list">
        ...
        {includeCV && (<li className="social-item cv"><Link to="/cv/machine-learning-engineer" title="Roman Glushko's CVs" target="blank"><FontAwesomeIcon icon={faBriefcase} size={iconSize} /></Link></li>)}
