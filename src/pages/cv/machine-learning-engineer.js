            ...
            <section className="projects">
                ...
                <li className="project">
                  ...
                  <ul className="project-details">
                    ...
                    <li>
                      ...
                      •{" "}
                      <a
                        href="https://github.com/roma-glushko/rock-paper-scissors"
                        target="blank"
                      >
                        GitHub
                      </a>
                  ...
                  <li className="project">
                    ...
                    <ul className="project-details">
                      ...
                      <li>
                        ...
                        •{" "}
                        <a
                          href="https://github.com/roma-glushko/kaggle-mall-customer-segmentation"
                          target="blank"
                        >
                          Github
                        </a>
                  ...
                  <li className="project">
                    ...
                    <ul className="project-details">
                      ...
                      <li>
                        ...
                        •{" "}
                        <a
                          href="https://github.com/roma-glushko/kaggle-digit-recognizer"
                          target="blank"
                        >
                          Github
                        </a>
                  ...
                  <li className="project">
                    ...
                    <ul className="project-details">
                      ...
                      <li>
                        ...
                        •{" "}
                        <a
                          href="https://github.com/roma-glushko/kaggle-wine-quality"
                          target="blank"
                        >
                          Github
                        </a>
                  ...
                  <li className="project">
                    ...
                    <ul className="project-details">
                      ...
                      <li>
                        ...
                        •{" "}
                        <a
                          href="https://github.com/roma-glushko/kaggle-house-prices"
                          target="blank"
                        >
                          Github
                        </a>
              ...
              <span className="other-projects-link">
                ...
                <a
                  target="_blank"
                  rel="noopener"
                  href="https://github.com/roma-glushko?tab=repositories&q=machine-learning"
                >
                  GitHub
                </a>{" "}
                and{" "}
