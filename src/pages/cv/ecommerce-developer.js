              ...
              <ul>
                <li className="project">
                  ...
                  <div className="project-description">
                    ...
                    My team delivered their partner portal powered by <strong>Adobe Commerce Cloud just in 6 weeks</strong>. This included <strong>ERP and custom product configurator integrations, importing all B2B and catalog</strong> information and other stuff required by fully functional store.<br/><br/>
                    Also, I took part in concepts creation for the further features (package management capabilities for planned orders, integration with support system, B2B shipping, etc) and B2C branch of their business.
                  </div>
