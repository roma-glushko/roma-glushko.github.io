              ...
              <ul>
                ...
                <li className="project">
                  ...
                  <div className="project-description">
                    ...
                    They were on Magento 1 and they asked us for migration to Magento 2 Open Source. On Magento 1, they had <strong>a lot of custom functionality</strong>. We spent more than a year redesigning and implementing it on Magento 2. Since a major part of their sales came from showrooms, we paid extra attention on <strong>creating an omnichannel-like experience</strong> for their customers. 
                    We developed a workflow for their showroom stuff to let them guide and <strong>create quotes together with customers which came to the store</strong>. Also, the client's team was interested in making changes to most parts of the website frequently, so we provided them a way to <strong>manage blocks of information on category and product pages in an admin-friendly way.</strong><br/><br/>
              ...
              <ul>
                <li itemScope itemType="http://schema.org/Organization" className="job">
                  ...
                  <div className="job-description">
                    ...
                    Finally, I <strong>advocated the needs of software engineers and popularized ideas</strong> of solution sharing inside of the company.
                  </div>
                  <ul className="project-details">
