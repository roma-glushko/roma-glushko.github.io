    ...
    <Layout>
      ...
      <main className="rockpaperscissor-wrapper">
        <div id="intro" className="into content">
          <p>
            <strong>Rock, paper, scissors</strong> is a legendary hand game that
            many of us played with friends in childhood.
          </p>
          <p>
            ...
            ), which you both form simultaneously. Your goal is to guess a shape
          ...
          <p>
            The game requests your web camera access and loads a computer vision
            model directly into your browser (the game is completely
            serverless).
          </p>
          <p>
            ...
            which computer simultaneously made with you. The game compares both
            choices and updates your scores.
          </p>
